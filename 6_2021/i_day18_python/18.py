...
input = open("18_input").read()
#input = open("18_test").read()
...
The input must be read from a file called 18_input
...
Your puzzle answer was 4235.--- Part Two ---You notice a second question on the back of the homework assignment:
...
Your puzzle answer was 4659.Both parts of this puzzle are complete! They provide two gold stars: **
